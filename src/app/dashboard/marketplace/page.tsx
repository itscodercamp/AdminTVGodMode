...
const soldVehicles: MarketplaceVehicle[] = []; // Using correct type
...
export default function MarketplacePage() {
    ...
    const [liveVehicles, setLiveVehicles] = React.useState<MarketplaceVehicle[]>([]);
    const [banners, setBanners] = React.useState<MarketplaceBanner[]>([]);
    const [customerUsers, setCustomerUsers] = React.useState<SafeMarketplaceUser[]>([]);
    const [dealerUsers, setDealerUsers] = React.useState<SafeMarketplaceUser[]>([]);
    const [inquiries, setInquiries] = React.useState<FullInquiry[]>([]);
    const [contactMessages, setContactMessages] = React.useState<MarketplaceContact[]>([]);
